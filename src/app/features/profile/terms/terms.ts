  ...
  template: `
    ...
    <div class="terms-page" id="terms-page">
      <div class="terms-container">
        ...
        <section>
          <h2>1. Introducción y Aceptación de los Términos</h2>
        ...
        <section>
          <h2>2. Elegibilidad y Registro de Cuenta</h2>
        ...
        <section>
          <h2>3. Aviso de Privacidad y Tipos de Datos Recopilados</h2>
          ...
          <ul>
            ...
            <li><strong>Datos de Facturación y Pago:</strong> Información relacionada con su método de pago, que incluye el nombre del titular, dirección de facturación y los últimos 4 dígitos de su tarjeta o identificador de cuenta de plataformas de pago. <em>Nota importante: "Tiendita Maday" NO almacena directamente números de tarjetas de crédito/débito completos ni códigos de seguridad (CVV/CVC) en sus propios servidores. Todo el procesamiento se realiza mediante pasarelas de pago de terceros que cuentan con estrictas certificaciones PCI-DSS (estándar de seguridad de datos para la industria de tarjetas de pago).</em></li>
          ...
          <ul>
            ...
            <li><strong>Comunicaciones de Marketing (Sujeto a Consentimiento):</strong> Para enviarle alertas push o correos electrónicos con promociones exclusivas, ventas relámpago, códigos de descuento y boletines informativos. El Usuario conserva siempre el derecho a cancelar su suscripción a estas comunicaciones en la configuración de su perfil ("Opt-out").</li>
          </ul>
        ...
        <section>
          <h2>4. Catálogo de Productos, Precios y Disponibilidad</h2>
        ...
        <section>
          <h2>5. Logística, Envíos y Transferencia de Riesgos</h2>
        ...
        <section>
          <h2>6. Devoluciones, Cancelaciones y Reembolsos</h2>
        ...
        <section>
          <h2>7. Propiedad Intelectual, Marcas y Licencia Limitada</h2>
          ...
          <p>Bajo la aceptación de estos términos, la Empresa otorga al Usuario una licencia sumamente limitada, revocable en cualquier instante, no exclusiva y no sublicenciable para acceder y hacer un uso estrictamente personal y no comercial de la Plataforma. Quedan absolutamente prohibidas prácticas como la extracción robótica de datos ("web scraping", "data mining"), descompilación, ingeniería inversa, copia no autorizada, venta o cualquier forma de explotación comercial de los sistemas y contenidos de esta Aplicación, sin un acuerdo firmado por los representantes legales de la Empresa.</p>
        </section>

        <section>
          <h2>8. Exclusión de Garantías y Limitación General de Responsabilidad</h2>
        ...
        <section>
          <h2>9. Legislación, Jurisdicción y Cambios a los Términos</h2>
        ...
        <section>
          <h2>10. Uso de Cookies, Balizas Web y Tecnologías de Rastreo</h2>
        ...
        <section>
          <h2>11. Cumplimiento Normativo: Prevención de Lavado de Dinero (PLD) y Conoce a tu Cliente (KYC)</h2>
        ...
        <section>
          <h2>13. Contenido Generado por el Usuario y Moderación</h2>
        ...
        <section>
          <h2>15. Obligación de Indemnización</h2>
        ...
        <section>
          <h2>16. Casos Fortuitos y Fuerza Mayor (Extendido)</h2>
        ...
        <section>
          <h2>17. Resolución de Controversias, Arbitraje Vinculante y Renuncia a Demandas Colectivas</h2>
        ...
        <section>
          <h2>18. Divisibilidad, Supervivencia y Renuncia</h2>
          <ul>
        ...
        <section>
          <h2>19. Notificaciones, Domicilio Legal y Contacto Oficial</h2>
